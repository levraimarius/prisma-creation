<template>
  <div class="relative py-24 overflow-hidden bg-gray-900 isolate sm:py-32">
    <img
      ...
      :src="fondImage"
      alt="Image de fond pour l'agence web de Pont-Sainte-Maxence - Prisma Création"
      draggable="false"
    />
      ...
      <div class="max-w-3xl mx-auto lg:mx-0">
        <h1 class="mb-6 text-4xl font-bold text-gray-900 md:text-5xl anime-title">
          ...
          <span class="highlight-container">
            ...
            <span class="highlight">Pont-Sainte-Maxence</span>
          </span>
        </h1>
        <p class="mt-8 text-lg font-medium text-gray-600 text-pretty sm:text-xl/8">
          Découvrez Prisma Création, votre agence web à Pont-Sainte-Maxence. Création de sites web professionnels, performants et adaptés à vos besoins.
        </p>
      </div>
...
export default defineComponent({
  name: "AgenceWebPontSainteMaxence",
  components: {
    Services,
    Contact,
  },
  setup() {
    ...
    onMounted(() => {
      document.title = "Prisma Création | Agence Web à Pont-Sainte-Maxence - Votre site internet à prix réduit";
    });
