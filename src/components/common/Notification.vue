<template>
  ...
  >
    <div
      v-if="visible"
      ref="notification"
      class="fixed z-50 w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg pointer-events-auto bottom-4 right-4 sm:max-w-sm ring-1 ring-black ring-opacity-5"
      role="alert"
      aria-live="assertive"
    >
      <div class="p-4">
